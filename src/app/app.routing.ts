...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'roster', loadChildren: () => import('app/modules/admin/roster/roster.module').then(m => m.RosterModule)},
            {path: 'user', loadChildren: () => import('app/modules/admin/user/user.module').then(m => m.UserModule)},
            {path: 'team', loadChildren: () => import('app/modules/admin/team/team.module').then(m => m.TeamModule)},
